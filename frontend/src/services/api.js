...
export const deleteAllLancamentos = () => api.delete('/lancamentos/all');
...
export const analyzeInvoice = (formData) => api.post('/lancamentos/analyze-invoice', formData, {
  headers: { 'Content-Type': 'multipart/form-data' }
});
export const confirmInvoiceImport = (data) => api.post('/lancamentos/confirm-import', data);
